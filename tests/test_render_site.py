...
class RenderSiteTest(unittest.TestCase):
    def test_render_site_uses_profile_and_target_tags(self):
        ...
        self.assertIn('title="CV"', home)
        self.assertIn('href="assets/cv/resume.html"', home)
        self.assertNotIn("Download my CV", home)
        self.assertIn("Work Experience", home)
        self.assertIn("assets/logos/nju.svg", home)
        ...
        self.assertIn('title="CV"', home_zh)
        self.assertIn('href="assets/cv/resume-zh.html"', home_zh)
        self.assertIn("关于我", home_zh)
