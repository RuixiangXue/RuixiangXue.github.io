...
class RenderSiteTest(unittest.TestCase):
    def test_render_site_uses_profile_and_target_tags(self):
        ...
        self.assertIn('href="https://ruixiangxue.github.io/assets/cv/resume-en-20260628-v2.pdf"', home)
        self.assertIn('href="https://ruixiangxue.github.io/assets/cv/resume-zh-20260628-v2.pdf"', home)
